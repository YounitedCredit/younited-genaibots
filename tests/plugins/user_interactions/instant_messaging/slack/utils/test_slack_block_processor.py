...
def test_process_rich_text_section_or_preformatted_with_user(slack_block_processor):
    ...
    assert result == "Some Text User Mention: <@U123456>"
...
def test_extract_text_from_blocks_complex(slack_block_processor):
    blocks = [
        ...
        {"type": "input", "label": {"text": "Label Text"}, "element": {"placeholder": {"text": "Input Placeholder"}}}
    ]
    result = slack_block_processor.extract_text_from_blocks(blocks)
    assert result == "Header Section Text Context Text Rich Text :star: Label Text Input Placeholder"
