...
async def test_handle_action(azure_llama370b_plugin):
    with patch.object(azure_llama370b_plugin.commandr_client.chat.completions, 'create', new_callable=AsyncMock) as mock_create, \
         patch.object(azure_llama370b_plugin.session_manager_dispatcher, 'get_or_create_session', new_callable=AsyncMock) as mock_get_or_create_session, \
         patch.object(azure_llama370b_plugin.session_manager_dispatcher, 'save_session', new_callable=AsyncMock) as mock_save_session, \
         patch.object(azure_llama370b_plugin.session_manager_dispatcher, 'append_messages', new_callable=MagicMock) as mock_append_messages, \
